...
import AdminCustomerAnalysis from "./Category/AdminCustomerAnalysis";
...
const AdminPanel = () => {
  ...
  const [customersdetails,setCustomerDetails]=useState(null)
  ...
  const fetchData = async () => {
    try {
      ...
      console.log('inner-api  result', result)
    ...
    try {
      ...
      if (response?.data?.data) {
        if (type === "order") {
          ...
          setShowModal(true);
        } else if(type === "customer-analysis"){
          setSelectedCustomer(response?.data?.data?.customeranalysis)
        }
      } else {
  ...
  const handleShowOrder = (customerId) => {
    // alert(`Show orders for Customer ID: ${customerId}`);
          ...
          <div className="card mx-auto" style={{ width: "1050px" }}>
            <div className="card-body">
              ...
              <ul className="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li className="nav-item" role="presentation">
                  <button
                    ...
                    aria-controls="customer"
                    aria-selected={activeTab === "customer"}
                    onClick={() => handleTabChange("customer-analysis")}>
              ...
              <div className="tab-content mt-3" id="myTabContent">
                ...
                <div
                  className={`tab-pane fade ${
                    activeTab === "customer-analysis" ? "show active" : ""
                  }`}
